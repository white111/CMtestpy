...
#
# Descr:      Product1 Specific Library
#
...
CMtestVersion['Product1'] = VER + CVS_VER
#_____________________________________________________________________________
use Init_HA;
#use MIME::Lite;    # Email capabilites

#__________________________________________________________________________
sub Get_Volts_Example {  # This isn't really necessary unless we want parametrics
...
def AssignMac_Example(Match, Exclude ) :
	""" Assign and check for duplicate MAC addresess"""

        chassis_serialnumber = ""
        chassis_partnumberrev = ""
        chassis_5slotpartnum = "00315"
        chassis_partnumber = ""
        chassis_partnumber_version = ""
        chassis_revison = ""
        order_number = ""
        imc_pcba_temp = ""
        Chassis_product_code = "007"
	answerok = "N"
        answer = "" 
